...
import { ArrowLeft, ArrowRight, Calendar, Clock, User, BookOpen, Share2 } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#F7F3E9] text-[#172C26] pt-24 pb-20">
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-4 mb-8">
          ...
          <p className="text-base sm:text-lg text-[#59665E] font-medium leading-relaxed">
            {guide.subtitle}
          </p>
        </div>

        {/* Hero Image */}
        <div className="relative h-[320px] sm:h-[450px] w-full rounded-3xl overflow-hidden bg-[#082D27] mb-12 shadow-lg">
          <img
            src={guide.heroImage}
            alt={guide.title}
        ...
        <div className="bg-[#FFFDF7] rounded-3xl p-6 sm:p-12 border border-[#DEDCCD] shadow-sm space-y-8">
