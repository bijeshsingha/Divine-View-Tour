  ...
  return (
    <div className="flex-1 flex flex-col pt-8 pb-12 px-6 h-full grow animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="shrink-0 flex justify-start mb-2">
        <button aria-label="Return to home page" onClick={() => router.push('/')} className="w-12 h-12 flex items-center justify-center border-2 border-stone-200 text-stone-600 rounded-2xl hover:bg-stone-100 transition-all active:scale-95 bg-white shrink-0">
      ...
      <div className="mb-8 shrink-0 text-center mt-2">
        ...
        <p className="text-stone-600 text-base max-w-sm mx-auto">Choose a hassle-free readymade package, or craft your own custom itinerary from scratch.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 pb-4">
        ...
        >
          ...
          <p className="text-stone-600 text-sm">Choose from our perfectly curated, hassle-free tour packages. Best for first-timers.</p>
        </button>

        <div className="flex items-center justify-center gap-4 py-2">
          <div className="h-px bg-stone-100 flex-1"></div>
          <span className="text-stone-500 font-bold uppercase text-xs">OR</span>
          <div className="h-px bg-stone-100 flex-1"></div>
        </div>
        ...
        >
          ...
          <p className="text-stone-600 text-sm">Hand-pick your destinations and let us calculate the route. Best for seasoned travelers.</p>
        </button>
