  ...
  return (
    <div className="flex-1 flex flex-col bg-background min-h-screen animate-in fade-in slide-in-from-right-4 duration-300 pb-28">
      ...
      <div className="bg-foreground pt-16 pb-24 px-6 text-center relative">
        ...
        <div className="w-16 h-16 bg-foreground text-slate-300 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <PencilRuler className="w-8 h-8" />
        </div>
        <h1 className="font-serif text-3xl md:text-5xl font-extrabold text-white mb-4">Custom Itineraries</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 space-y-10 w-full -mt-16 relative z-10">
        ...
        <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200">
          <h2 className="font-serif text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
            <Sliders className="w-6 h-6 text-primary-dark" /> Total Flexibility
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-background p-4 rounded-2xl border border-stone-100">
              <div className="font-bold text-foreground text-lg mb-1">1. Choose Region</div>
              <p className="text-sm text-background0">Pick where you want to go and how many days you have.</p>
            </div>
            <div className="bg-background p-4 rounded-2xl border border-stone-100">
              <div className="font-bold text-foreground text-lg mb-1">2. Handpick Spots</div>
              <p className="text-sm text-background0">Select only the places you actually want to visit.</p>
            </div>
            <div className="bg-background p-4 rounded-2xl border border-stone-100">
              <div className="font-bold text-foreground text-lg mb-1">3. Select Transport</div>
              <p className="text-sm text-background0">Choose between budget shuttles or private fleets.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-primary/10 border border-primary/20 rounded-2xl p-6 md:p-8">
          <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2">
            <CheckCircle className="w-6 h-6 text-primary-dark" /> What to expect
          </h3>
          <ul className="space-y-4">
            <li className="flex gap-3 text-foreground">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600 mt-1">As you change your vehicle or stay type, the cost per person updates instantly at the bottom of your screen.</p>
              </div>
            </li>
            <li className="flex gap-3 text-foreground">
              <span className="font-bold text-primary-dark">•</span> 
              <div>
                ...
                <p className="text-sm text-stone-600 mt-1">Once you submit your custom request, our team will review the spots and create an optimized day-by-day route for you.</p>
              </div>
            </li>
            <li className="flex gap-3 text-foreground">
              <span className="font-bold text-primary-dark">•</span> 
              <div>
                ...
                <p className="text-sm text-stone-600 mt-1">Don't want our hotels? Just book the transport. Want a mix of everything? We can do that too.</p>
              </div>
            </li>
          </ul>
        </section>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-stone-200 p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-40 flex justify-center">
        <button 
          onClick={() => router.push('/build?path=custom')}
          className="w-full max-w-sm bg-foreground text-white font-extrabold py-4 px-6 rounded-2xl shadow-lg hover:bg-foreground transition-all text-center"
        >
