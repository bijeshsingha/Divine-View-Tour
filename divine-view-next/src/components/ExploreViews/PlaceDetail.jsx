...
export default function PlaceDetail({ place }) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-background min-h-screen animate-in fade-in duration-300 pb-28">
      ...
      <div className="relative w-full h-[50vh] md:h-[60vh] bg-foreground overflow-hidden shrink-0">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 text-white">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              {place.tags?.map((tag, idx) => (
                <span key={idx} className="bg-secondary text-foreground text-xs px-3 py-1 rounded-full font-bold shadow-sm">
                  {tag}
                </span>
              ))}
            ...
            <h1 className="font-serif text-4xl md:text-6xl font-extrabold tracking-tight">{place.title}</h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="md:col-span-8 space-y-10">
            ...
            <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200">
              <h2 className="font-serif text-2xl font-bold text-foreground mb-4">About this spot</h2>
              {isNohkalikai ? (
                <>
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-3">The Legend of Ka Likai</h3>
                ...
                <>
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-3">The Legend</h3>
                  <p className="text-stone-600 leading-relaxed text-lg">
            ...
            {isNohkalikai && (
              <section className="bg-emerald-50 rounded-2xl p-6 md:p-8 border border-emerald-100">
            ...
            {isNohkalikai && (
              <section className="bg-stone-50 rounded-2xl p-6 md:p-8 border border-stone-100">
                <h3 className="text-xl font-bold text-secondary-dark mb-4 flex items-center gap-2">
                  <Info className="w-6 h-6 text-secondary" /> Pro-Tips for Visitors
                </h3>
            ...
            <section className="flex flex-col sm:flex-row gap-4 pt-4">
              {place.googleMapsUrl && (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="flex-1 bg-white border-2 border-stone-200 text-stone-700 font-bold py-4 px-6 rounded-2xl hover:border-blue-400 hover:text-blue-600 transition-colors flex items-center justify-center gap-2 shadow-sm"
                >
              ...
              {place.instagramUrl && (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="flex-1 bg-white border-2 border-stone-200 text-stone-700 font-bold py-4 px-6 rounded-2xl hover:border-pink-400 hover:text-pink-600 transition-colors flex items-center justify-center gap-2 shadow-sm"
                >
          ...
          <div className="md:col-span-4 relative">
            <div className="sticky top-8 space-y-6">
              ...
              {/* Quick Facts Card */}
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-xl shadow-slate-200/50 border border-stone-100">
                ...
                {isNohkalikai ? (
                  <div className="space-y-5">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Height & Record</div>
                        <div className="font-medium text-foreground mt-1">1,115 feet (340 meters). The tallest plunge waterfall in India.</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                        <IndianRupee className="w-5 h-5 text-primary-dark" />
                      </div>
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Entry & Camera Fee</div>
                        <div className="font-medium text-foreground mt-1">₹20 per person. ₹20 additional charge for cameras.</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Timings & Duration</div>
                        <div className="font-medium text-foreground mt-1">9:00 AM to 5:00 PM. Typically spend 1 to 2 hours here.</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Location</div>
                        <div className="font-medium text-foreground mt-1">5 km from Cherrapunji town.</div>
                      </div>
                    </div>
                  </div>
                ) : isWariChora ? (
                  <div className="space-y-5">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Activity</div>
                        <div className="font-medium text-foreground mt-1">Kayaking, Canoeing, Short Trek.</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Terrain & Base</div>
                        <div className="font-medium text-foreground mt-1">Rugged off-road drive followed by 30-45 min steep trek. Base: Emangre.</div>
                      </div>
                    </div>
                  </div>
                ) : isDzukou ? (
                  <div className="space-y-5">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Duration & Difficulty</div>
                        <div className="font-medium text-foreground mt-1">2 Days / 1 Night. Easy-Moderate (steep initial climb of 1.5–3 hours).</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Altitude & Start</div>
                        <div className="font-medium text-foreground mt-1">~8,000 ft. Starts from Viswema (gentler) or Zakhama (steeper).</div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <div className="text-xs text-background0 font-semibold uppercase">Entry Fee</div>
                        <div className="font-medium text-foreground mt-1">~₹30 per person.</div>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-5">
                    <p className="text-background0 text-sm italic">Quick facts specific to this location are coming soon.</p>
                  </div>
                )}
                ...
                <div className="mt-8 pt-6 border-t border-stone-100">
                  <button 
                    ...
                    className="w-full bg-foreground text-white font-extrabold py-4 px-6 rounded-2xl shadow-lg hover:bg-foreground transition-all flex items-center justify-center gap-2 text-center"
                  >
                    View Tour Packages
                  </button>
                </div>
              ...
              {place.packageLinked && (
                <div className="bg-stone-50 border border-stone-200 rounded-2xl p-5 shadow-sm">
                  <h3 className="font-bold text-secondary-dark mb-2">Want to visit here without the hassle?</h3>
