  ...
  return (
    <div className="flex-1 flex flex-col pt-8 pb-12 px-6 h-full grow animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="shrink-0 flex justify-start mb-2">
        <button onClick={() => navigate('/')} className="w-12 h-12 flex items-center justify-center border-2 border-stone-200 text-stone-600 rounded-2xl hover:bg-background transition-all active:scale-95 bg-white shrink-0">
