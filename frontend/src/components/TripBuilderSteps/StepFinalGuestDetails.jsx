  ...
  return (
    <div className="flex-1 flex flex-col pt-8 pb-12 px-6 h-full grow animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="mb-6 shrink-0 text-center">
        <h2 className="font-serif text-3xl font-extrabold text-foreground mb-2">Almost There!</h2>
        <p className="text-background0 text-base">We just need a few details to finalize your quote.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-start overflow-y-auto pb-4 space-y-5">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border-2 border-stone-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-foreground">Lead Guest Name</h3>
          </div>
          <input
            type="text"
            className="w-full p-3 rounded-xl border-2 border-stone-200 bg-white focus:border-primary focus:ring-4 focus:ring-brand/20 outline-none text-stone-700 text-base font-medium transition-all"
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border-2 border-stone-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-foreground">Email Address <span className="text-slate-400 font-normal text-sm">(Optional)</span></h3>
          </div>
          <input
            type="email"
            className="w-full p-3 rounded-xl border-2 border-stone-200 bg-white focus:border-primary focus:ring-4 focus:ring-brand/20 outline-none text-stone-700 text-base font-medium transition-all"
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border-2 border-stone-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-foreground">Number of Travelers</h3>
          </div>
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <input
                type="number"
                min="1"
                className="w-full p-3 rounded-xl border-2 border-stone-200 bg-white focus:border-primary focus:ring-4 focus:ring-brand/20 outline-none text-stone-700 text-center font-bold transition-all"
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border-2 border-stone-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-foreground">Preferred Travel Date</h3>
          </div>
          <input
            type="date"
            className="w-full text-base p-3 border-2 border-stone-200 rounded-xl focus:border-primary focus:ring-4 focus:ring-brand/20 outline-none text-stone-700 font-semibold bg-white shadow-sm transition-all"
